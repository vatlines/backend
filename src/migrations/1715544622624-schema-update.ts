...
export class SchemaUpdate1715544622624 implements MigrationInterface {
  name = 'SchemaUpdate1715544622624';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."button_type_enum" AS ENUM('SHOUT', 'OVERRIDE', 'INTERCOM', 'RING', 'NONE', 'CONVERTED_SHOUT')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "editors" ADD CONSTRAINT "FK_3a9e132570f2ff4282f1e7f12f0" FOREIGN KEY ("facilityFacilityId") REFERENCES "facility"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "position" ADD CONSTRAINT "FK_237d67b997aed694f242f0522da" FOREIGN KEY ("facilityFacilityId") REFERENCES "facility"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "button" ADD CONSTRAINT "FK_5b38fac084fb0ff638e95e7c5f5" FOREIGN KEY ("facilityFacilityId") REFERENCES "facility"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "configuration-layout" ADD CONSTRAINT "FK_ac2cf043fdb7a824902fbbe8ecf" FOREIGN KEY ("configurationId") REFERENCES "position_configuration"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "configuration-layout" ADD CONSTRAINT "FK_faee05098d1905d2069cfe79556" FOREIGN KEY ("buttonId") REFERENCES "button"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "position_configurations_positions" ADD CONSTRAINT "FK_34c3d74875229333877e600cd08" FOREIGN KEY ("positionId") REFERENCES "position"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
